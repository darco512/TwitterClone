...
<template>
    <div class="bg-white border rounded p-4 shadow mb-3">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-3 gap-3">
            <div v-for="attachment of post.attachments" class="">
                <div class="group bg-blue-100 aspect-square flex flex-col items-center justify-center text-gray-500 relative mb-3">
                    <button class="opacity-0 group-hover:opacity-100 transitions-all w-8 h-8 flex items-center justify-center cursor-pointer absolute top-2 right-2 bg-gray-600 hover:bg-gray-800 rounded text-gray-100">
